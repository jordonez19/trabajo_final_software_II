  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          token = req.headers["access-token"]; //pedimos el token
          if (token) {
            _context.next = 4;
            break;
          }
        ...
        case 4:
          decoded = _jsonwebtoken["default"].verify(token, _config["default"].SECRET); //decoded.id me da el id a reconocer
